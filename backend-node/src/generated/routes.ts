...
const models: TsoaRoute.Models = {
    ...
    "UpdateTestDiagnosticiRequest": {
        "dataType": "refObject",
        "properties": {
            "testDiagnostici": {"ref":"Record_string.string-Array_","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsRepairController_updateClienteRepair: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                body: {"in":"body","name":"body","required":true,"ref":"UpdateClienteRepairRequest"},
        };
        app.patch('/repairs/:id/cliente',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(RepairController)),
            ...(fetchMiddlewares<RequestHandler>(RepairController.prototype.updateClienteRepair)),

            async function RepairController_updateClienteRepair(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsRepairController_updateClienteRepair, request, response });

                const controller = new RepairController();

              await templateService.apiHandler({
                methodName: 'updateClienteRepair',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsProductController_updateProductTestDiagnostici: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"double"},
                body: {"in":"body","name":"body","required":true,"ref":"UpdateTestDiagnosticiRequest"},
        };
        app.patch('/products/:id/test-diagnostici',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(ProductController)),
            ...(fetchMiddlewares<RequestHandler>(ProductController.prototype.updateProductTestDiagnostici)),

            async function ProductController_updateProductTestDiagnostici(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsProductController_updateProductTestDiagnostici, request, response });

                const controller = new ProductController();

              await templateService.apiHandler({
                methodName: 'updateProductTestDiagnostici',
                controller,
                response,
                next,
                validatedArgs,
